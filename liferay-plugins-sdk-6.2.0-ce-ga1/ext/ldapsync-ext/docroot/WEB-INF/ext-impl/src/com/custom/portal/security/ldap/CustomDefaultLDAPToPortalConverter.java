 ...
 */
public class CustomDefaultLDAPToPortalConverter extends DefaultLDAPToPortalConverter 
	implements CustomLDAPToPortalConverter 
	 {
	...
	public CustomLDAPUser importLDAPUser(
		...
		phone.setNumber((LDAPUtil.getAttributeString(
				attributes, contactMappings, CustomContactConverterKeys.PHONE)));
		
		ldapUser.setPhone(phone);
		
		Address address = AddressUtil.create(0);
		
		address.setCity((LDAPUtil.getAttributeString(
				attributes, contactMappings, CustomContactConverterKeys.CITY)));
		address.setZip((LDAPUtil.getAttributeString(
				attributes, contactMappings, CustomContactConverterKeys.ZIP)));
		address.setStreet1((LDAPUtil.getAttributeString(
				attributes, contactMappings, CustomContactConverterKeys.STREET)));
	...
	private static Log _log = LogFactoryUtil.getLog(
		CustomDefaultLDAPToPortalConverter.class);
